  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('coupon:seckillskunotice:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量刪除</el-button>
      </el-form-item>
    </el-form>
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column prop="sessionId" header-align="center" align="center" label="活動場次id">
      </el-table-column>
      <el-table-column prop="subcribeTime" header-align="center" align="center" label="訂閲時間">
      </el-table-column>
      <el-table-column prop="sendTime" header-align="center" align="center" label="發送時間">
      </el-table-column>
      <el-table-column prop="noticeType" header-align="center" align="center" label="通知方式[0-短信，1-郵件]">
      </el-table-column>
