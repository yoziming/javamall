  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('coupon:homeadv:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量刪除</el-button>
      </el-form-item>
    </el-form>
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column prop="pic" header-align="center" align="center" label="圖片地址">
      </el-table-column>
      <el-table-column prop="startTime" header-align="center" align="center" label="開始時間">
      </el-table-column>
      <el-table-column prop="endTime" header-align="center" align="center" label="結束時間">
      </el-table-column>
      <el-table-column prop="status" header-align="center" align="center" label="狀態">
      </el-table-column>
      <el-table-column prop="clickCount" header-align="center" align="center" label="點擊數">
      </el-table-column>
      ...
      <el-table-column prop="publisherId" header-align="center" align="center" label="發佈者">
      </el-table-column>
      <el-table-column prop="authId" header-align="center" align="center" label="審核者">
      </el-table-column>
