      ...
      <el-col :span="24" v-show="step == 0">
        <el-card class="box-card" style="width: 80%; margin: 20px auto">
          <el-form ref="spuBaseForm" :model="spu" label-width="120px" :rules="spuBaseInfoRules">
            ...
            <el-form-item label="設置積分" prop="bounds">
              <label>金幣</label>
              <el-input-number style="width: 130px" placeholder="金幣" v-model="spu.bounds.buyBounds" :min="0" controls-position="right"></el-input-number>
              <label style="margin-left: 15px">成長值</label>
              <el-input-number style="width: 130px" placeholder="成長值" v-model="spu.bounds.growBounds" :min="0" controls-position="right">
                        ...
                        <el-row>
                          ...
                          <el-col :span="12">
                            <el-tag v-if="scope.row.images[index].defaultImg == 1">
                              <input type="radio" checked :name="scope.row.skuName" @change="checkDefaultImg(scope.row, index, img)" />設為默認
                            </el-tag>
                            <el-tag v-else>
                              <input type="radio" :name="scope.row.skuName" @change="checkDefaultImg(scope.row, index, img)" />設為默認
                            </el-tag>
                          </el-col>
                        </el-row>
                      </div>
                  ...
                  <el-row>
                    <el-col :span="24">
                      <el-form-item label="設置折扣">
                        ...
                        <label>折</label>
                        <el-checkbox v-model="scope.row.countStatus" :true-label="1" :false-label="0">可疊加優惠</el-checkbox>
                      </el-form-item>
                    </el-col>
                    <el-col :span="24">
                      <el-form-item label="設置滿減">
                        <label>滿</label>
                        ...
                        <label>元</label>
                        <el-checkbox v-model="scope.row.priceStatus" :true-label="1" :false-label="0">可疊加優惠</el-checkbox>
                      </el-form-item>
                    </el-col>

                    <el-col :span="24">
                      <el-form-item label="設置會員價" v-if="scope.row.memberPrice.length > 0">
                        <br />
