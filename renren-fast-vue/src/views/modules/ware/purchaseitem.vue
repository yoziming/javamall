  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item label="關鍵字">
        <el-input style="width:120px;" v-model="dataForm.key" placeholder="參數名" clearable></el-input>
      </el-form-item>
      <el-form-item>
        ...
        <el-dropdown @command="handleBatchCommand" :disabled="dataListSelections.length <= 0">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item command="delete">批量刪除</el-dropdown-item>
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column prop="status" header-align="center" align="center" label="狀態">
        <template slot-scope="scope">
          ...
          <el-tag type="danger" v-if="scope.row.status==4">採購失敗</el-tag>
        </template>
      </el-table-column>
