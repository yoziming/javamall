...
CREATE TABLE `schedule_job` (
  ...
  PRIMARY KEY (`job_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='定時任務';

-- ----------------------------
-- Records of schedule_job
-- ----------------------------
INSERT INTO `schedule_job` VALUES ('1', 'testTask', 'renren', '0 0/30 * * * ?', '0', '參數測試', '2019-09-30 02:46:30');
...
CREATE TABLE `schedule_job_log` (
  ...
  PRIMARY KEY (`log_id`),
  KEY `job_id` (`job_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1307 DEFAULT CHARSET=utf8mb4 COMMENT='定時任務日誌';
...
CREATE TABLE `sys_captcha` (
  ...
  PRIMARY KEY (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='系統驗證碼';
...
CREATE TABLE `sys_config` (
  ...
  `status` tinyint(4) DEFAULT '1' COMMENT '狀態   0：隱藏   1：顯示',
  `remark` varchar(500) DEFAULT NULL COMMENT '備註',
  PRIMARY KEY (`id`),
  UNIQUE KEY `param_key` (`param_key`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='系統配置信息表';

-- ----------------------------
-- Records of sys_config
-- ----------------------------
INSERT INTO `sys_config` VALUES ('1', 'CLOUD_STORAGE_CONFIG_KEY', '{\"aliyunAccessKeyId\":\"\",\"aliyunAccessKeySecret\":\"\",\"aliyunBucketName\":\"\",\"aliyunDomain\":\"\",\"aliyunEndPoint\":\"\",\"aliyunPrefix\":\"\",\"qcloudBucketName\":\"\",\"qcloudDomain\":\"\",\"qcloudPrefix\":\"\",\"qcloudSecretId\":\"\",\"qcloudSecretKey\":\"\",\"qiniuAccessKey\":\"NrgMfABZxWLo5B-YYSjoE8-AZ1EISdi1Z3ubLOeZ\",\"qiniuBucketName\":\"ios-app\",\"qiniuDomain\":\"http://7xqbwh.dl1.z0.glb.clouddn.com\",\"qiniuPrefix\":\"upload\",\"qiniuSecretKey\":\"uIwJHevMRWU0VLxFvgy0tAcOdGqasdtVlJkdy6vV\",\"type\":1}', '0', '雲存儲配置信息');
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8mb4 COMMENT='系統日誌';

-- ----------------------------
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES ('1', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":31,\"parentId\":0,\"name\":\"商品系統\",\"url\":\"\",\"perms\":\"\",\"type\":0,\"icon\":\"editor\",\"orderNum\":0}]', '9', '0:0:0:0:0:0:0:1', '2019-10-28 21:34:21');
INSERT INTO `sys_log` VALUES ('2', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":32,\"parentId\":31,\"name\":\"分類維護\",\"url\":\"product/category\",\"perms\":\"\",\"type\":1,\"icon\":\"menu\",\"orderNum\":0}]', '8', '0:0:0:0:0:0:0:1', '2019-10-28 21:35:21');
INSERT INTO `sys_log` VALUES ('3', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":33,\"parentId\":31,\"name\":\"品牌管理\",\"url\":\"product/brand\",\"perms\":\"\",\"type\":1,\"icon\":\"editor\",\"orderNum\":0}]', '17', '0:0:0:0:0:0:0:1', '2019-11-06 10:19:56');
INSERT INTO `sys_log` VALUES ('4', 'admin', '刪除菜單', 'io.renren.modules.sys.controller.SysMenuController.delete()', '[33]', '322', '0:0:0:0:0:0:0:1', '2019-11-06 10:40:06');
INSERT INTO `sys_log` VALUES ('5', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":34,\"parentId\":31,\"name\":\"品牌管理\",\"url\":\"product/brand\",\"perms\":\"\",\"type\":1,\"icon\":\"editor\",\"orderNum\":0}]', '8', '0:0:0:0:0:0:0:1', '2019-11-06 10:52:28');
INSERT INTO `sys_log` VALUES ('6', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":35,\"parentId\":31,\"name\":\"屬性維護\",\"url\":\"\",\"perms\":\"\",\"type\":0,\"icon\":\"system\",\"orderNum\":0}]', '11', '0:0:0:0:0:0:0:1', '2019-11-13 11:59:27');
INSERT INTO `sys_log` VALUES ('7', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":36,\"parentId\":35,\"name\":\"基本屬性\",\"url\":\"product/baseatr\",\"perms\":\"\",\"type\":1,\"icon\":\"\",\"orderNum\":0}]', '8', '0:0:0:0:0:0:0:1', '2019-11-13 11:59:56');
INSERT INTO `sys_log` VALUES ('8', 'admin', '刪除菜單', 'io.renren.modules.sys.controller.SysMenuController.delete()', '[35]', '4', '0:0:0:0:0:0:0:1', '2019-11-13 12:08:23');
INSERT INTO `sys_log` VALUES ('9', 'admin', '刪除菜單', 'io.renren.modules.sys.controller.SysMenuController.delete()', '[36]', '311', '0:0:0:0:0:0:0:1', '2019-11-13 12:08:28');
INSERT INTO `sys_log` VALUES ('10', 'admin', '刪除菜單', 'io.renren.modules.sys.controller.SysMenuController.delete()', '[35]', '11', '0:0:0:0:0:0:0:1', '2019-11-13 12:08:34');
INSERT INTO `sys_log` VALUES ('11', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":37,\"parentId\":31,\"name\":\"平台屬性\",\"url\":\"\",\"perms\":\"\",\"type\":0,\"icon\":\"system\",\"orderNum\":0}]', '11', '0:0:0:0:0:0:0:1', '2019-11-13 20:05:22');
INSERT INTO `sys_log` VALUES ('12', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":38,\"parentId\":37,\"name\":\"屬性分組\",\"url\":\"product/attrgroup\",\"perms\":\"\",\"type\":1,\"icon\":\"tubiao\",\"orderNum\":0}]', '7', '0:0:0:0:0:0:0:1', '2019-11-13 20:06:12');
INSERT INTO `sys_log` VALUES ('13', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":39,\"parentId\":37,\"name\":\"規格參數\",\"url\":\"product/baseattr\",\"perms\":\"\",\"type\":1,\"icon\":\"log\",\"orderNum\":0}]', '6', '0:0:0:0:0:0:0:1', '2019-11-13 20:07:29');
INSERT INTO `sys_log` VALUES ('14', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":40,\"parentId\":37,\"name\":\"銷售屬性\",\"url\":\"product/saleattr\",\"perms\":\"\",\"type\":1,\"icon\":\"zonghe\",\"orderNum\":0}]', '8', '0:0:0:0:0:0:0:1', '2019-11-13 20:08:00');
INSERT INTO `sys_log` VALUES ('15', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":41,\"parentId\":31,\"name\":\"商品維護\",\"url\":\"product/spu\",\"perms\":\"\",\"type\":1,\"icon\":\"zonghe\",\"orderNum\":0}]', '7', '0:0:0:0:0:0:0:1', '2019-11-13 20:13:12');
INSERT INTO `sys_log` VALUES ('16', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":42,\"parentId\":0,\"name\":\"優惠營銷\",\"url\":\"\",\"perms\":\"\",\"type\":0,\"icon\":\"mudedi\",\"orderNum\":0}]', '5', '0:0:0:0:0:0:0:1', '2019-11-13 20:14:52');
INSERT INTO `sys_log` VALUES ('17', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":43,\"parentId\":0,\"name\":\"庫存系統\",\"url\":\"\",\"perms\":\"\",\"type\":0,\"icon\":\"shouye\",\"orderNum\":0}]', '7', '0:0:0:0:0:0:0:1', '2019-11-13 20:15:20');
INSERT INTO `sys_log` VALUES ('18', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":44,\"parentId\":0,\"name\":\"訂單系統\",\"url\":\"\",\"perms\":\"\",\"type\":0,\"icon\":\"config\",\"orderNum\":0}]', '5', '0:0:0:0:0:0:0:1', '2019-11-13 20:15:48');
INSERT INTO `sys_log` VALUES ('19', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":45,\"parentId\":0,\"name\":\"用户系統\",\"url\":\"\",\"perms\":\"\",\"type\":0,\"icon\":\"admin\",\"orderNum\":0}]', '5', '0:0:0:0:0:0:0:1', '2019-11-13 20:16:12');
INSERT INTO `sys_log` VALUES ('20', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":46,\"parentId\":0,\"name\":\"內容管理\",\"url\":\"\",\"perms\":\"\",\"type\":0,\"icon\":\"sousuo\",\"orderNum\":0}]', '3', '0:0:0:0:0:0:0:1', '2019-11-13 20:16:56');
INSERT INTO `sys_log` VALUES ('21', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":47,\"parentId\":42,\"name\":\"優惠券管理\",\"url\":\"coupon/coupon\",\"perms\":\"\",\"type\":1,\"icon\":\"zhedie\",\"orderNum\":0}]', '7', '0:0:0:0:0:0:0:1', '2019-11-13 20:19:59');
INSERT INTO `sys_log` VALUES ('22', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":48,\"parentId\":42,\"name\":\"發放記錄\",\"url\":\"coupon/history\",\"perms\":\"\",\"type\":1,\"icon\":\"sql\",\"orderNum\":0}]', '15', '0:0:0:0:0:0:0:1', '2019-11-13 20:20:52');
INSERT INTO `sys_log` VALUES ('23', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":49,\"parentId\":42,\"name\":\"專題活動\",\"url\":\"coupon/subject\",\"perms\":\"\",\"type\":1,\"icon\":\"tixing\",\"orderNum\":0}]', '7', '0:0:0:0:0:0:0:1', '2019-11-13 20:21:58');
INSERT INTO `sys_log` VALUES ('24', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":50,\"parentId\":42,\"name\":\"秒殺活動\",\"url\":\"coupon/seckill\",\"perms\":\"\",\"type\":1,\"icon\":\"daohang\",\"orderNum\":0}]', '7', '0:0:0:0:0:0:0:1', '2019-11-13 20:22:32');
INSERT INTO `sys_log` VALUES ('25', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":51,\"parentId\":42,\"name\":\"積分維護\",\"url\":\"coupon/bounds\",\"perms\":\"\",\"type\":1,\"icon\":\"geren\",\"orderNum\":0}]', '5', '0:0:0:0:0:0:0:1', '2019-11-13 20:25:13');
INSERT INTO `sys_log` VALUES ('26', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":52,\"parentId\":42,\"name\":\"滿減折扣\",\"url\":\"coupon/full\",\"perms\":\"\",\"type\":1,\"icon\":\"shoucang\",\"orderNum\":0}]', '9', '0:0:0:0:0:0:0:1', '2019-11-13 20:26:21');
INSERT INTO `sys_log` VALUES ('27', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":53,\"parentId\":43,\"name\":\"倉庫維護\",\"url\":\"ware/wareinfo\",\"perms\":\"\",\"type\":1,\"icon\":\"shouye\",\"orderNum\":0}]', '5', '0:0:0:0:0:0:0:1', '2019-11-13 20:27:51');
INSERT INTO `sys_log` VALUES ('28', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":54,\"parentId\":43,\"name\":\"庫存工作單\",\"url\":\"ware/task\",\"perms\":\"\",\"type\":1,\"icon\":\"log\",\"orderNum\":0}]', '14', '0:0:0:0:0:0:0:1', '2019-11-13 20:28:55');
INSERT INTO `sys_log` VALUES ('29', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":55,\"parentId\":43,\"name\":\"商品庫存\",\"url\":\"ware/sku\",\"perms\":\"\",\"type\":1,\"icon\":\"jiesuo\",\"orderNum\":0}]', '5', '0:0:0:0:0:0:0:1', '2019-11-13 20:29:31');
INSERT INTO `sys_log` VALUES ('30', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":56,\"parentId\":44,\"name\":\"訂單查詢\",\"url\":\"order/order\",\"perms\":\"\",\"type\":1,\"icon\":\"zhedie\",\"orderNum\":0}]', '6', '0:0:0:0:0:0:0:1', '2019-11-13 20:31:55');
INSERT INTO `sys_log` VALUES ('31', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":57,\"parentId\":44,\"name\":\"退貨單處理\",\"url\":\"order/return\",\"perms\":\"\",\"type\":1,\"icon\":\"shanchu\",\"orderNum\":0}]', '5', '0:0:0:0:0:0:0:1', '2019-11-13 20:33:04');
INSERT INTO `sys_log` VALUES ('32', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":58,\"parentId\":44,\"name\":\"等級規則\",\"url\":\"order/settings\",\"perms\":\"\",\"type\":1,\"icon\":\"system\",\"orderNum\":0}]', '5', '0:0:0:0:0:0:0:1', '2019-11-13 20:34:34');
INSERT INTO `sys_log` VALUES ('33', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":59,\"parentId\":44,\"name\":\"支付流水查詢\",\"url\":\"order/payment\",\"perms\":\"\",\"type\":1,\"icon\":\"job\",\"orderNum\":0}]', '5', '0:0:0:0:0:0:0:1', '2019-11-13 20:37:41');
INSERT INTO `sys_log` VALUES ('34', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":60,\"parentId\":44,\"name\":\"退款流水查詢\",\"url\":\"order/refund\",\"perms\":\"\",\"type\":1,\"icon\":\"mudedi\",\"orderNum\":0}]', '6', '0:0:0:0:0:0:0:1', '2019-11-13 20:38:16');
INSERT INTO `sys_log` VALUES ('35', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":61,\"parentId\":45,\"name\":\"會員列表\",\"url\":\"member/member\",\"perms\":\"\",\"type\":1,\"icon\":\"geren\",\"orderNum\":0}]', '7', '0:0:0:0:0:0:0:1', '2019-11-13 20:40:14');
INSERT INTO `sys_log` VALUES ('36', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":62,\"parentId\":45,\"name\":\"會員等級\",\"url\":\"member/level\",\"perms\":\"\",\"type\":1,\"icon\":\"tubiao\",\"orderNum\":0}]', '14', '0:0:0:0:0:0:0:1', '2019-11-13 20:40:34');
INSERT INTO `sys_log` VALUES ('37', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":63,\"parentId\":45,\"name\":\"積分變化\",\"url\":\"member/growth\",\"perms\":\"\",\"type\":1,\"icon\":\"bianji\",\"orderNum\":0}]', '6', '0:0:0:0:0:0:0:1', '2019-11-13 20:43:14');
INSERT INTO `sys_log` VALUES ('38', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":64,\"parentId\":45,\"name\":\"統計信息\",\"url\":\"member/statistics\",\"perms\":\"\",\"type\":1,\"icon\":\"sql\",\"orderNum\":0}]', '4', '0:0:0:0:0:0:0:1', '2019-11-13 20:43:52');
INSERT INTO `sys_log` VALUES ('39', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":65,\"parentId\":46,\"name\":\"首頁推薦\",\"url\":\"content/index\",\"perms\":\"\",\"type\":1,\"icon\":\"shouye\",\"orderNum\":0}]', '6', '0:0:0:0:0:0:0:1', '2019-11-13 20:44:47');
INSERT INTO `sys_log` VALUES ('40', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":66,\"parentId\":46,\"name\":\"分類熱門\",\"url\":\"content/category\",\"perms\":\"\",\"type\":1,\"icon\":\"zhedie\",\"orderNum\":0}]', '7', '0:0:0:0:0:0:0:1', '2019-11-13 20:45:24');
INSERT INTO `sys_log` VALUES ('41', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":67,\"parentId\":46,\"name\":\"評論管理\",\"url\":\"content/comments\",\"perms\":\"\",\"type\":1,\"icon\":\"pinglun\",\"orderNum\":0}]', '20', '0:0:0:0:0:0:0:1', '2019-11-13 20:48:21');
INSERT INTO `sys_log` VALUES ('42', 'admin', '修改菜單', 'io.renren.modules.sys.controller.SysMenuController.update()', '[{\"menuId\":41,\"parentId\":31,\"name\":\"商品維護\",\"url\":\"product/spu\",\"perms\":\"\",\"type\":0,\"icon\":\"zonghe\",\"orderNum\":0}]', '11', '0:0:0:0:0:0:0:1', '2019-11-17 12:18:52');
INSERT INTO `sys_log` VALUES ('43', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":68,\"parentId\":41,\"name\":\"spu管理\",\"url\":\"product/spu\",\"perms\":\"\",\"type\":1,\"icon\":\"config\",\"orderNum\":0}]', '9', '0:0:0:0:0:0:0:1', '2019-11-17 12:19:52');
INSERT INTO `sys_log` VALUES ('44', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":69,\"parentId\":41,\"name\":\"發佈商品\",\"url\":\"product/spuadd\",\"perms\":\"\",\"type\":1,\"icon\":\"bianji\",\"orderNum\":0}]', '14', '0:0:0:0:0:0:0:1', '2019-11-17 12:49:04');
INSERT INTO `sys_log` VALUES ('45', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":70,\"parentId\":43,\"name\":\"採購單維護\",\"url\":\"\",\"perms\":\"\",\"type\":0,\"icon\":\"tubiao\",\"orderNum\":0}]', '12', '0:0:0:0:0:0:0:1', '2019-11-17 13:29:35');
INSERT INTO `sys_log` VALUES ('46', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":71,\"parentId\":70,\"name\":\"發佈採購項\",\"url\":\"ware/purchaseitem\",\"perms\":\"\",\"type\":1,\"icon\":\"editor\",\"orderNum\":0}]', '7', '0:0:0:0:0:0:0:1', '2019-11-17 13:30:23');
INSERT INTO `sys_log` VALUES ('47', 'admin', '修改菜單', 'io.renren.modules.sys.controller.SysMenuController.update()', '[{\"menuId\":71,\"parentId\":70,\"name\":\"採購需求\",\"url\":\"ware/purchaseitem\",\"perms\":\"\",\"type\":1,\"icon\":\"editor\",\"orderNum\":0}]', '6', '0:0:0:0:0:0:0:1', '2019-11-17 13:30:57');
INSERT INTO `sys_log` VALUES ('48', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":72,\"parentId\":70,\"name\":\"採購單\",\"url\":\"ware/purchase\",\"perms\":\"\",\"type\":1,\"icon\":\"menu\",\"orderNum\":0}]', '5', '0:0:0:0:0:0:0:1', '2019-11-17 13:31:32');
INSERT INTO `sys_log` VALUES ('49', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":73,\"parentId\":41,\"name\":\"商品管理\",\"url\":\"product/manager\",\"perms\":\"\",\"type\":1,\"icon\":\"zonghe\",\"orderNum\":0}]', '8', '0:0:0:0:0:0:0:1', '2019-11-17 13:36:18');
INSERT INTO `sys_log` VALUES ('50', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":74,\"parentId\":42,\"name\":\"會員價格\",\"url\":\"coupon/memberprice\",\"perms\":\"\",\"type\":1,\"icon\":\"\",\"orderNum\":0}]', '11', '0:0:0:0:0:0:0:1', '2019-11-24 16:23:33');
INSERT INTO `sys_log` VALUES ('51', 'admin', '修改菜單', 'io.renren.modules.sys.controller.SysMenuController.update()', '[{\"menuId\":74,\"parentId\":42,\"name\":\"會員價格\",\"url\":\"coupon/memberprice\",\"perms\":\"\",\"type\":1,\"icon\":\"admin\",\"orderNum\":0}]', '9', '0:0:0:0:0:0:0:1', '2019-11-24 16:23:48');
...
INSERT INTO `sys_log` VALUES ('53', 'admin', '保存菜單', 'io.renren.modules.sys.controller.SysMenuController.save()', '[{\"menuId\":75,\"parentId\":42,\"name\":\"每日秒殺\",\"url\":\"aaaaaaaa\",\"perms\":\"\",\"type\":1,\"icon\":\"job\",\"orderNum\":0}]', '8', '0:0:0:0:0:0:0:1', '2020-02-18 18:42:37');
INSERT INTO `sys_log` VALUES ('54', 'admin', '修改菜單', 'io.renren.modules.sys.controller.SysMenuController.update()', '[{\"menuId\":75,\"parentId\":42,\"name\":\"每日秒殺\",\"url\":\"coupon/seckillsession\",\"perms\":\"\",\"type\":1,\"icon\":\"job\",\"orderNum\":0}]', '11', '0:0:0:0:0:0:0:1', '2020-02-18 18:43:10');
...
CREATE TABLE `sys_menu` (
  ...
  `parent_id` bigint(20) DEFAULT NULL COMMENT '父菜單ID，一級菜單為0',
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 COMMENT='菜單管理';
...
INSERT INTO `sys_menu` VALUES ('5', '1', 'SQL監控', 'http://localhost:8080/renren-fast/druid/sql.html', null, '1', 'sql', '4');
INSERT INTO `sys_menu` VALUES ('6', '1', '定時任務', 'job/schedule', null, '1', 'job', '5');
INSERT INTO `sys_menu` VALUES ('7', '6', '查看', null, 'sys:schedule:list,sys:schedule:info', '2', null, '0');
INSERT INTO `sys_menu` VALUES ('8', '6', '新增', null, 'sys:schedule:save', '2', null, '0');
INSERT INTO `sys_menu` VALUES ('9', '6', '修改', null, 'sys:schedule:update', '2', null, '0');
INSERT INTO `sys_menu` VALUES ('10', '6', '刪除', null, 'sys:schedule:delete', '2', null, '0');
INSERT INTO `sys_menu` VALUES ('11', '6', '暫停', null, 'sys:schedule:pause', '2', null, '0');
INSERT INTO `sys_menu` VALUES ('12', '6', '恢復', null, 'sys:schedule:resume', '2', null, '0');
INSERT INTO `sys_menu` VALUES ('13', '6', '立即執行', null, 'sys:schedule:run', '2', null, '0');
INSERT INTO `sys_menu` VALUES ('14', '6', '日誌列表', null, 'sys:schedule:log', '2', null, '0');
...
INSERT INTO `sys_menu` VALUES ('27', '1', '參數管理', 'sys/config', 'sys:config:list,sys:config:info,sys:config:save,sys:config:update,sys:config:delete', '1', 'config', '6');
INSERT INTO `sys_menu` VALUES ('29', '1', '系統日誌', 'sys/log', 'sys:log:list', '1', 'log', '7');
INSERT INTO `sys_menu` VALUES ('30', '1', '文件上傳', 'oss/oss', 'sys:oss:all', '1', 'oss', '6');
INSERT INTO `sys_menu` VALUES ('31', '0', '商品系統', '', '', '0', 'editor', '0');
INSERT INTO `sys_menu` VALUES ('32', '31', '分類維護', 'product/category', '', '1', 'menu', '0');
INSERT INTO `sys_menu` VALUES ('34', '31', '品牌管理', 'product/brand', '', '1', 'editor', '0');
INSERT INTO `sys_menu` VALUES ('37', '31', '平台屬性', '', '', '0', 'system', '0');
...
INSERT INTO `sys_menu` VALUES ('41', '31', '商品維護', 'product/spu', '', '0', 'zonghe', '0');
INSERT INTO `sys_menu` VALUES ('42', '0', '優惠營銷', '', '', '0', 'mudedi', '0');
INSERT INTO `sys_menu` VALUES ('43', '0', '庫存系統', '', '', '0', 'shouye', '0');
INSERT INTO `sys_menu` VALUES ('44', '0', '訂單系統', '', '', '0', 'config', '0');
INSERT INTO `sys_menu` VALUES ('45', '0', '用户系統', '', '', '0', 'admin', '0');
INSERT INTO `sys_menu` VALUES ('46', '0', '內容管理', '', '', '0', 'sousuo', '0');
INSERT INTO `sys_menu` VALUES ('47', '42', '優惠券管理', 'coupon/coupon', '', '1', 'zhedie', '0');
INSERT INTO `sys_menu` VALUES ('48', '42', '發放記錄', 'coupon/history', '', '1', 'sql', '0');
INSERT INTO `sys_menu` VALUES ('49', '42', '專題活動', 'coupon/subject', '', '1', 'tixing', '0');
INSERT INTO `sys_menu` VALUES ('50', '42', '秒殺活動', 'coupon/seckill', '', '1', 'daohang', '0');
INSERT INTO `sys_menu` VALUES ('51', '42', '積分維護', 'coupon/bounds', '', '1', 'geren', '0');
INSERT INTO `sys_menu` VALUES ('52', '42', '滿減折扣', 'coupon/full', '', '1', 'shoucang', '0');
INSERT INTO `sys_menu` VALUES ('53', '43', '倉庫維護', 'ware/wareinfo', '', '1', 'shouye', '0');
...
INSERT INTO `sys_menu` VALUES ('58', '44', '等級規則', 'order/settings', '', '1', 'system', '0');
...
INSERT INTO `sys_menu` VALUES ('62', '45', '會員等級', 'member/level', '', '1', 'tubiao', '0');
INSERT INTO `sys_menu` VALUES ('63', '45', '積分變化', 'member/growth', '', '1', 'bianji', '0');
INSERT INTO `sys_menu` VALUES ('64', '45', '統計信息', 'member/statistics', '', '1', 'sql', '0');
INSERT INTO `sys_menu` VALUES ('65', '46', '首頁推薦', 'content/index', '', '1', 'shouye', '0');
INSERT INTO `sys_menu` VALUES ('66', '46', '分類熱門', 'content/category', '', '1', 'zhedie', '0');
INSERT INTO `sys_menu` VALUES ('67', '46', '評論管理', 'content/comments', '', '1', 'pinglun', '0');
INSERT INTO `sys_menu` VALUES ('68', '41', 'spu管理', 'product/spu', '', '1', 'config', '0');
INSERT INTO `sys_menu` VALUES ('69', '41', '發佈商品', 'product/spuadd', '', '1', 'bianji', '0');
INSERT INTO `sys_menu` VALUES ('70', '43', '採購單維護', '', '', '0', 'tubiao', '0');
INSERT INTO `sys_menu` VALUES ('71', '70', '採購需求', 'ware/purchaseitem', '', '1', 'editor', '0');
INSERT INTO `sys_menu` VALUES ('72', '70', '採購單', 'ware/purchase', '', '1', 'menu', '0');
INSERT INTO `sys_menu` VALUES ('73', '41', '商品管理', 'product/manager', '', '1', 'zonghe', '0');
INSERT INTO `sys_menu` VALUES ('74', '42', '會員價格', 'coupon/memberprice', '', '1', 'admin', '0');
INSERT INTO `sys_menu` VALUES ('75', '42', '每日秒殺', 'coupon/seckillsession', '', '1', 'job', '0');
...
CREATE TABLE `sys_oss` (
  ...
  `create_date` datetime DEFAULT NULL COMMENT '創建時間',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='文件上傳';
...
CREATE TABLE `sys_role` (
  ...
  `create_user_id` bigint(20) DEFAULT NULL COMMENT '創建者ID',
  `create_time` datetime DEFAULT NULL COMMENT '創建時間',
  PRIMARY KEY (`role_id`)
...
CREATE TABLE `sys_role_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='角色與菜單對應關係';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='系統用户';
...
CREATE TABLE `sys_user_role` (
  ...
  `role_id` bigint(20) DEFAULT NULL COMMENT '角色ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户與角色對應關係';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='系統用户Token';
