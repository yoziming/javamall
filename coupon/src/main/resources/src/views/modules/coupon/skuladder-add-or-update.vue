<template>
  <el-dialog
    ...
    <el-form-item label="是否疊加其他優惠[0-不可疊加，1-可疊加]" prop="addOther">
      <el-input v-model="dataForm.addOther" placeholder="是否疊加其他優惠[0-不可疊加，1-可疊加]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          fullCount: [
            { required: true, message: '滿幾件不能为空', trigger: 'blur' }
          ],
          discount: [
            { required: true, message: '打幾折不能为空', trigger: 'blur' }
          ],
          price: [
            { required: true, message: '折後價不能为空', trigger: 'blur' }
          ],
          addOther: [
            { required: true, message: '是否疊加其他優惠[0-不可疊加，1-可疊加]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
