<template>
  <el-dialog
    ...
    <el-form-item label="是否參與其他優惠" prop="addOther">
      <el-input v-model="dataForm.addOther" placeholder="是否參與其他優惠"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          fullPrice: [
            { required: true, message: '滿多少不能为空', trigger: 'blur' }
          ],
          reducePrice: [
            { required: true, message: '減多少不能为空', trigger: 'blur' }
          ],
          addOther: [
            { required: true, message: '是否參與其他優惠不能为空', trigger: 'blur' }
          ]
        }
      }
    },
