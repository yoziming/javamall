<template>
  <el-dialog
    ...
    <el-form-item label="活動id" prop="promotionId">
      <el-input v-model="dataForm.promotionId" placeholder="活動id"></el-input>
    </el-form-item>
    <el-form-item label="活動場次id" prop="promotionSessionId">
      <el-input v-model="dataForm.promotionSessionId" placeholder="活動場次id"></el-input>
    </el-form-item>
    ...
    <el-form-item label="秒殺價格" prop="seckillPrice">
      <el-input v-model="dataForm.seckillPrice" placeholder="秒殺價格"></el-input>
    </el-form-item>
    <el-form-item label="秒殺總量" prop="seckillCount">
      <el-input v-model="dataForm.seckillCount" placeholder="秒殺總量"></el-input>
    </el-form-item>
    <el-form-item label="每人限購數量" prop="seckillLimit">
      <el-input v-model="dataForm.seckillLimit" placeholder="每人限購數量"></el-input>
    </el-form-item>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          promotionId: [
            { required: true, message: '活動id不能为空', trigger: 'blur' }
          ],
          promotionSessionId: [
            { required: true, message: '活動場次id不能为空', trigger: 'blur' }
          ],
          skuId: [
            { required: true, message: '商品id不能为空', trigger: 'blur' }
          ],
          seckillPrice: [
            { required: true, message: '秒殺價格不能为空', trigger: 'blur' }
          ],
          seckillCount: [
            { required: true, message: '秒殺總量不能为空', trigger: 'blur' }
          ],
          seckillLimit: [
            { required: true, message: '每人限購數量不能为空', trigger: 'blur' }
          ],
          seckillSort: [
