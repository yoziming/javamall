<template>
  <el-dialog
    ...
    <el-form-item label="訂閲時間" prop="subcribeTime">
      <el-input v-model="dataForm.subcribeTime" placeholder="訂閲時間"></el-input>
    </el-form-item>
    <el-form-item label="發送時間" prop="sendTime">
      <el-input v-model="dataForm.sendTime" placeholder="發送時間"></el-input>
    </el-form-item>
    <el-form-item label="通知方式[0-短信，1-郵件]" prop="noticeType">
      <el-input v-model="dataForm.noticeType" placeholder="通知方式[0-短信，1-郵件]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          subcribeTime: [
            { required: true, message: '訂閲時間不能为空', trigger: 'blur' }
          ],
          sendTime: [
            { required: true, message: '發送時間不能为空', trigger: 'blur' }
          ],
          noticeType: [
            { required: true, message: '通知方式[0-短信，1-郵件]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
