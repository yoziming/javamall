<template>
  <el-dialog
    ...
    <el-form-item label="可否疊加其他優惠[0-不可疊加優惠，1-可疊加]" prop="addOther">
      <el-input v-model="dataForm.addOther" placeholder="可否疊加其他優惠[0-不可疊加優惠，1-可疊加]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          memberLevelName: [
            { required: true, message: '會員等級名不能为空', trigger: 'blur' }
          ],
          memberPrice: [
            { required: true, message: '會員對應價格不能为空', trigger: 'blur' }
          ],
          addOther: [
            { required: true, message: '可否疊加其他優惠[0-不可疊加優惠，1-可疊加]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
