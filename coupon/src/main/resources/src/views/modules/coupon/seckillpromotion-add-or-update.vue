<template>
  <el-dialog
    ...
    <el-form-item label="開始日期" prop="startTime">
      <el-input v-model="dataForm.startTime" placeholder="開始日期"></el-input>
    </el-form-item>
    <el-form-item label="結束日期" prop="endTime">
      <el-input v-model="dataForm.endTime" placeholder="結束日期"></el-input>
    </el-form-item>
    <el-form-item label="上下線狀態" prop="status">
      <el-input v-model="dataForm.status" placeholder="上下線狀態"></el-input>
    </el-form-item>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          title: [
            { required: true, message: '活動標題不能为空', trigger: 'blur' }
          ],
          startTime: [
            { required: true, message: '開始日期不能为空', trigger: 'blur' }
          ],
          endTime: [
            { required: true, message: '結束日期不能为空', trigger: 'blur' }
          ],
          status: [
            { required: true, message: '上下線狀態不能为空', trigger: 'blur' }
          ],
          createTime: [
            { required: true, message: '創建時間不能为空', trigger: 'blur' }
          ],
          userId: [
            { required: true, message: '創建人不能为空', trigger: 'blur' }
          ]
        }
      }
    },
