<template>
  <el-dialog
    ...
    <el-form-item label="變化的值" prop="changeCount">
      <el-input v-model="dataForm.changeCount" placeholder="變化的值"></el-input>
    </el-form-item>
    <el-form-item label="備註" prop="note">
      <el-input v-model="dataForm.note" placeholder="備註"></el-input>
    </el-form-item>
    <el-form-item label="來源[0->購物；1->管理員修改;2->活動]" prop="sourceTyoe">
      <el-input v-model="dataForm.sourceTyoe" placeholder="來源[0->購物；1->管理員修改;2->活動]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          changeCount: [
            { required: true, message: '變化的值不能为空', trigger: 'blur' }
          ],
          note: [
            { required: true, message: '備註不能为空', trigger: 'blur' }
          ],
          sourceTyoe: [
            { required: true, message: '來源[0->購物；1->管理員修改;2->活動]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
