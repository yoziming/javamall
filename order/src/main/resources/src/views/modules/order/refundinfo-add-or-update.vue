  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          orderReturnId: [
            { required: true, message: '退款的訂單不能为空', trigger: 'blur' }
          ],
          refund: [
            { required: true, message: '退款金額不能为空', trigger: 'blur' }
          ],
          refundSn: [
            { required: true, message: '退款交易流水號不能为空', trigger: 'blur' }
          ],
          refundStatus: [
            { required: true, message: '退款狀態不能为空', trigger: 'blur' }
          ],
          refundChannel: [
            { required: true, message: '退款渠道[1-支付寶，2-微信，3-銀聯，4-匯款]不能为空', trigger: 'blur' }
          ],
          refundContent: [
