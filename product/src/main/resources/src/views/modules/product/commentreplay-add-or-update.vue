<template>
  <el-dialog
    ...
    <el-form-item label="評論id" prop="commentId">
      <el-input v-model="dataForm.commentId" placeholder="評論id"></el-input>
    </el-form-item>
    <el-form-item label="回覆id" prop="replyId">
      <el-input v-model="dataForm.replyId" placeholder="回覆id"></el-input>
    </el-form-item>
    </el-form>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          commentId: [
            { required: true, message: '評論id不能为空', trigger: 'blur' }
          ],
          replyId: [
            { required: true, message: '回覆id不能为空', trigger: 'blur' }
          ]
        }
      }
    },
