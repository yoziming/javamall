<template>
  <el-dialog
    ...
    <el-form-item label="銷售屬性名" prop="attrName">
      <el-input v-model="dataForm.attrName" placeholder="銷售屬性名"></el-input>
    </el-form-item>
    <el-form-item label="銷售屬性值" prop="attrValue">
      <el-input v-model="dataForm.attrValue" placeholder="銷售屬性值"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          attrName: [
            { required: true, message: '銷售屬性名不能为空', trigger: 'blur' }
          ],
          attrValue: [
            { required: true, message: '銷售屬性值不能为空', trigger: 'blur' }
          ],
          attrSort: [
