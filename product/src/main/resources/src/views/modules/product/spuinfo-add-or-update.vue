<template>
  <el-dialog
    ...
    <el-form-item label="商品名稱" prop="spuName">
      <el-input v-model="dataForm.spuName" placeholder="商品名稱"></el-input>
    </el-form-item>
    ...
    <el-form-item label="上架狀態[0 - 下架，1 - 上架]" prop="publishStatus">
      <el-input v-model="dataForm.publishStatus" placeholder="上架狀態[0 - 下架，1 - 上架]"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          publishStatus: [
            { required: true, message: '上架狀態[0 - 下架，1 - 上架]不能为空', trigger: 'blur' }
          ],
          createTime: [
            { required: true, message: '不能为空', trigger: 'blur' }
          ],
