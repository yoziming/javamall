<template>
  <el-dialog
    ...
    <el-form-item label="sku名稱" prop="skuName">
      <el-input v-model="dataForm.skuName" placeholder="sku名稱"></el-input>
    </el-form-item>
    <el-form-item label="sku介紹描述" prop="skuDesc">
      <el-input v-model="dataForm.skuDesc" placeholder="sku介紹描述"></el-input>
    </el-form-item>
    <el-form-item label="所屬分類id" prop="catalogId">
      <el-input v-model="dataForm.catalogId" placeholder="所屬分類id"></el-input>
    </el-form-item>
    <el-form-item label="品牌id" prop="brandId">
      <el-input v-model="dataForm.brandId" placeholder="品牌id"></el-input>
    </el-form-item>
    <el-form-item label="默認圖片" prop="skuDefaultImg">
      <el-input v-model="dataForm.skuDefaultImg" placeholder="默認圖片"></el-input>
    </el-form-item>
    <el-form-item label="標題" prop="skuTitle">
      <el-input v-model="dataForm.skuTitle" placeholder="標題"></el-input>
    </el-form-item>
    <el-form-item label="副標題" prop="skuSubtitle">
      <el-input v-model="dataForm.skuSubtitle" placeholder="副標題"></el-input>
    </el-form-item>
    <el-form-item label="價格" prop="price">
      <el-input v-model="dataForm.price" placeholder="價格"></el-input>
    </el-form-item>
    <el-form-item label="銷量" prop="saleCount">
      <el-input v-model="dataForm.saleCount" placeholder="銷量"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          skuName: [
            { required: true, message: 'sku名稱不能为空', trigger: 'blur' }
          ],
          skuDesc: [
            { required: true, message: 'sku介紹描述不能为空', trigger: 'blur' }
          ],
          catalogId: [
            { required: true, message: '所屬分類id不能为空', trigger: 'blur' }
          ],
          brandId: [
            { required: true, message: '品牌id不能为空', trigger: 'blur' }
          ],
          skuDefaultImg: [
            { required: true, message: '默認圖片不能为空', trigger: 'blur' }
          ],
          skuTitle: [
            { required: true, message: '標題不能为空', trigger: 'blur' }
          ],
          skuSubtitle: [
            { required: true, message: '副標題不能为空', trigger: 'blur' }
          ],
          price: [
            { required: true, message: '價格不能为空', trigger: 'blur' }
          ],
          saleCount: [
            { required: true, message: '銷量不能为空', trigger: 'blur' }
          ]
        }
      }
    },
