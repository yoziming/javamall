<template>
  <el-dialog
    ...
    <el-form-item label="圖片名" prop="imgName">
      <el-input v-model="dataForm.imgName" placeholder="圖片名"></el-input>
    </el-form-item>
    <el-form-item label="圖片地址" prop="imgUrl">
      <el-input v-model="dataForm.imgUrl" placeholder="圖片地址"></el-input>
    </el-form-item>
    <el-form-item label="順序" prop="imgSort">
      <el-input v-model="dataForm.imgSort" placeholder="順序"></el-input>
    </el-form-item>
    <el-form-item label="是否默認圖" prop="defaultImg">
      <el-input v-model="dataForm.defaultImg" placeholder="是否默認圖"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          imgName: [
            { required: true, message: '圖片名不能为空', trigger: 'blur' }
          ],
          imgUrl: [
            { required: true, message: '圖片地址不能为空', trigger: 'blur' }
          ],
          imgSort: [
            { required: true, message: '順序不能为空', trigger: 'blur' }
          ],
          defaultImg: [
            { required: true, message: '是否默認圖不能为空', trigger: 'blur' }
          ]
        }
      }
    },
