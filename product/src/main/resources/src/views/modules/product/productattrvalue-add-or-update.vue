<template>
  <el-dialog
    ...
    <el-form-item label="屬性值" prop="attrValue">
      <el-input v-model="dataForm.attrValue" placeholder="屬性值"></el-input>
    </el-form-item>
    <el-form-item label="順序" prop="attrSort">
      <el-input v-model="dataForm.attrSort" placeholder="順序"></el-input>
    </el-form-item>
    <el-form-item label="快速展示【是否展示在介紹上；0-否 1-是】" prop="quickShow">
      <el-input v-model="dataForm.quickShow" placeholder="快速展示【是否展示在介紹上；0-否 1-是】"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          attrValue: [
            { required: true, message: '屬性值不能为空', trigger: 'blur' }
          ],
          attrSort: [
            { required: true, message: '順序不能为空', trigger: 'blur' }
          ],
          quickShow: [
            { required: true, message: '快速展示【是否展示在介紹上；0-否 1-是】不能为空', trigger: 'blur' }
          ]
        }
      }
    },
