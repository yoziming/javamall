<template>
  <el-dialog
    ...
    <el-form-item label="默認圖[0 - 不是默認圖，1 - 是默認圖]" prop="defaultImg">
      <el-input v-model="dataForm.defaultImg" placeholder="默認圖[0 - 不是默認圖，1 - 是默認圖]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          defaultImg: [
            { required: true, message: '默認圖[0 - 不是默認圖，1 - 是默認圖]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
