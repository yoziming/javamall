<template>
  <div>
    <!--    <el-switch v-model="draggable" active-text="開啓拖拽" inactive-text="關閉拖拽"></el-switch>
    <el-button v-if="draggable" @click="batchSave">批量保存</el-button>-->
    <el-button type="danger" @click="batchDelete">批量刪除</el-button>
    <el-button type="success" @click="addLevelOne()">添加</el-button>
    ...
    <el-tree :data="menus" :props="defaultProps" :expand-on-click-node="false" show-checkbox node-key="catId" :default-expanded-keys="expandedKey" :draggable="draggable" :allow-drop="allowDrop" @node-drop="handleDrop" ref="menuTree">
      <span class="custom-tree-node" slot-scope="{ node, data }">
        ...
        <span>
          ...
          <el-button v-if="node.childNodes.length==0" type="text" size="mini" @click="() => remove(node, data)">刪除</el-button>
        </span>
      </span>
    </el-tree>
