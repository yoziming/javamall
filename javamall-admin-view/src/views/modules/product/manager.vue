<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form :inline="true" :model="dataForm">
        ...
        <el-form-item label="檢索">
          <el-input style="width:160px" placeholder="sku名稱/id" v-model="dataForm.key" clearable></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;" @expand-change="getSkuDetails">
      ...
      <el-table-column prop="skuDefaultImg" header-align="center" align="center" label="預設圖片">
        <template slot-scope="scope">
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="stockSettings(scope.row)">庫存管理</el-button>
