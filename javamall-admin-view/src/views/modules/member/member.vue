<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input v-model="dataForm.memberUsername" placeholder="用户名" clearable></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column prop="mobile" header-align="center" align="center" label="郵箱"></el-table-column>
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          ...
          <el-button type="text" size="small" @click="toOrder(scope.row.username)">查訂單</el-button>
        </template>
      </el-table-column>
    </el-table>
