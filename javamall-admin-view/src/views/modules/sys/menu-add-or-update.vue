  ...
  <el-dialog :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      ...
      <el-form-item label="上級菜單" prop="parentName">
        ...
        <el-input v-model="dataForm.parentName" v-popover:menuListPopover :readonly="true" placeholder="點擊選擇上級菜單" class="menu-list__input"></el-input>
      </el-form-item>
      ...
      <el-form-item v-if="dataForm.type !== 2" label="菜單圖標" prop="icon">
        <el-row>
          <el-col :span="22">
            ...
            <el-input v-model="dataForm.icon" v-popover:iconListPopover :readonly="true" placeholder="菜單圖標名稱" class="icon-list__input"></el-input>
          </el-col>
          <el-col :span="2" class="icon-list__tips">
            <el-tooltip placement="top" effect="light">
              <div slot="content">全站推薦使用SVG Sprite, 詳細請參考:<a href="//github.com/daxiongYang/renren-fast-vue/blob/master/src/icons/index.js" target="_blank">icons/index.js</a>描述</div>
