    ...
    <el-tabs v-if="$route.meta.isTab" v-model="mainTabsActiveName" :closable="true" @tab-click="selectedTabHandle" @tab-remove="removeTabHandle">
      <el-dropdown class="site-tabs__tools" :show-timeout="0">
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item @click.native="tabsCloseCurrentHandle">關閉當前標籤頁</el-dropdown-item>
          <el-dropdown-item @click.native="tabsCloseOtherHandle">關閉其它標籤頁</el-dropdown-item>
          <el-dropdown-item @click.native="tabsCloseAllHandle">關閉全部標籤頁</el-dropdown-item>
          <el-dropdown-item @click.native="refresh()">刷新當前標籤頁</el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
